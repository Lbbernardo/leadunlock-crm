  ...
  return (
    <form onSubmit={handlePay} className="space-y-5">
      ...
      <div className="text-center pt-2">
        <p className="text-slate-500 text-sm mb-2">¿Tienes problemas con el pago?</p>
        <a
          href="https://wa.me/16304154252?text=Hola%2C%20tengo%20un%20problema%20con%20el%20pago%20de%20activaci%C3%B3n%20en%20LeadUnlock"
          target="_blank"
